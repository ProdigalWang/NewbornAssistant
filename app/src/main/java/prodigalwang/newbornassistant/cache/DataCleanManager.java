...
public class DataCleanManager {
    ...
    public static void cleanInternalCache() {
        deleteFilesByDirectory(MyApplication.getContext().getCacheDir());
//        deleteFilesByDirectory(context.getFilesDir());
    ...
    public static void cleanFiles() {
        deleteFilesByDirectory(MyApplication.getContext().getFilesDir());
    }
    /**
     * 清楚本应用所有数据库
    ...
    public static void cleanSharedPreference() {
        deleteFilesByDirectory(new File("/data/data/"
                + MyApplication.getContext().getPackageName() + "/shared_prefs"));
    }
    ...
    public static void cleanDatabaseByName(String dbName) {
        MyApplication.getContext().deleteDatabase(dbName);
    }
    ...
    public static void cleanExternalCache() {
        if (Environment.getExternalStorageState().equals(
            ...
            deleteFilesByDirectory(MyApplication.getContext().getExternalCacheDir());
        }
    }
